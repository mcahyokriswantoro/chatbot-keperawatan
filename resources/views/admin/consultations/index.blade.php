...
@section('content')
    <x-admin.page-banner
        ...
        :subtitle="$pendingCount > 0 ? $pendingCount.' pembayaran QRIS / Bank menunggu verifikasi' : 'Kelola pembayaran chat perawat'"
        tone="emerald"
    ...
    <div class="mb-4 rounded-2xl border border-sky-100 bg-sky-50/50 px-4 py-3 text-xs leading-relaxed text-slate-600">
        <strong>Cara verifikasi:</strong> cek mutasi masuk via QRIS (NERSIA HEALTH) atau Giro BRI
        <strong>004101003652303</strong>, cocokkan nominal & ID transaksi, lalu <strong>Setujui</strong> agar user bisa chat WhatsApp live.
    </div>
