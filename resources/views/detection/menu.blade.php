...
@section('content')
    <x-mobile.page-header title="Pilih Skrining" />

    <p class="mb-5 text-sm leading-relaxed text-slate-500">
        Pilih jenis penyakit yang ingin Anda skrining. Chatbot akan menanyakan gejala dan faktor risiko yang relevan.
    </p>

    @php
        $order = ['tb_paru', 'dhf', 'ppok', 'penyakit_ginjal', 'stroke', 'jantung_koroner', 'diabetes_melitus', 'hipertensi'];
    @endphp
